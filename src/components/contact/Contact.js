            ...
            <div className="col-sm-12 col-md-6 contact-left-container">
              ...
              <div>
                <div className="contact-icon">
                  {/* <p className='contact-icon' onClick={() =>window.open("https://wa.me/+918526223732", "_blank")}> <WhatsAppIcon fontSize='medium' /> +918526223732</p> */}
                  <p 
                    onClick={() =>
                  ...
                  <p
                    onClick={() =>
                      window.open(
                        "linkedin.com/in/oviya-chelladurai-1995661ab/",
                        "_blank"
                      )
                    }
                  >
                  ...
                  >
                    <CallIcon fontSize="medium" /> +918526223732
                  </p>
                  <p className="ss"
                    onClick={() =>
                  ...
                  >
                    <MailIcon fontSize="medium" /> oviya200@gmail.com
                  </p>
                </div>
                <div>
                  <img
